...
<body>
	...
	<div class="main container border border-1"
		...
		<form action="redirectPurchase.ds">
			<div class=" row ">
				<div class="col ">
					<table id="customers">
						<thead>
							<tr>
								...
								<th><select
									...
									style="width: 100%; color: black;">
										...
										<c:forEach var="supplierName" items="${supplierList}">
											<option>${supplierName.name}</option>
										</c:forEach>
								</select></th>
								<th><input type="text" name="qty" id="qty"
									placeholder="Qty" style="width: 100%;"></th>
				...
				<div class="fixed-bottom mb-4"
					...
					<div class=row>
						<div class="col" style="padding: 26px 0 0 772px;">
							<input type="submit" style="padding: 15px 48px 15px 48px;" class="btn btn-outline-success" value="Done">
							<input type="submit" style="padding: 15px 48px 15px 48px;" class="btn btn-outline-danger" value="Cancel">
