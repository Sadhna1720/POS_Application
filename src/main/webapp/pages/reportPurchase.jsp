...
<body>
	...
	<div class=" main container border boder-bottom-0"
		...
		<div class="fixed mt-4" style="margin-left: 86%;">		
			<button class="rounded border border-1" type="button" style="padding: 9px 59px 9px 59px;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
